      ...
      <section className="py-16 -mt-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {stats.map((stat, index) => <div key={index} className="bg-card rounded-2xl p-6 text-center shadow-elegant hover:shadow-hover transition-all duration-300 hover:-translate-y-1 border border-border/40">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Donasi Terbaru</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {popularDonations.map(donation => <DonationCard key={donation.id} {...donation} />)}
          </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="rounded-3xl overflow-hidden shadow-elegant aspect-square">
                    <img src="https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=400&auto=format&fit=crop" alt="Volunteer helping" className="w-full h-full object-cover" />
                  </div>
                  <div className="rounded-3xl overflow-hidden shadow-elegant aspect-[4/3]">
                    <img src="https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=400&auto=format&fit=crop" alt="Children receiving help" className="w-full h-full object-cover" />
                  </div>
                </div>
                <div className="space-y-4 pt-8">
                  <div className="rounded-3xl overflow-hidden shadow-elegant aspect-[4/3]">
                    <img src="https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=400&auto=format&fit=crop" alt="Community support" className="w-full h-full object-cover" />
                  </div>
                  <div className="rounded-3xl overflow-hidden shadow-elegant aspect-square">
                    <img src="https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=400&auto=format&fit=crop" alt="Donation activity" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
              {/* Decorative circle */}
      ...
      <section className="py-24 bg-gradient-to-br from-muted/30 to-background">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-12">
            ...
            <Button variant="outline" size="lg" className="border-2 group self-start md:self-auto" onClick={() => navigate('/laporan')}>
              Lihat Semua
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {reports && reports.length > 0 ? reports.map(report => <article key={report.id} className="group bg-card rounded-2xl overflow-hidden border border-border/40 shadow-elegant hover:shadow-hover transition-all duration-300 hover:-translate-y-1 cursor-pointer" onClick={() => navigate('/laporan')}>
                  <div className="aspect-video overflow-hidden">
                    <img src={report.image_url || "https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=600&auto=format&fit=crop"} alt={report.donations?.title || "Report"} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                  </div>
          ...
          [1, 2, 3].map(i => <article key={i} className="group bg-card rounded-2xl overflow-hidden border border-border/40 shadow-elegant hover:shadow-hover transition-all duration-300 hover:-translate-y-1 cursor-pointer" onClick={() => navigate('/laporan')}>
                  <div className="aspect-video overflow-hidden">
                    <img src={`https://images.unsplash.com/photo-${i === 1 ? '1559027615-cd4628902d4a' : i === 2 ? '1488521787991-ed7bbaae773c' : '1469571486292-0ba58a3f068b'}?w=600&auto=format&fit=crop`} alt="News" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                  </div>
                  <div className="p-6 space-y-3">
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      <Calendar className="h-4 w-4" />
