...
const Donasi = () => {
  ...
  const allDonations = Array.from({ length: 45 }, (_, i) => ({
    id: `${i + 1}`,
    title: [
      "Bantu Adik-Adik Kurang Mampu untuk Dapat Pendidikan Layak",
      "Renovasi Perpustakaan Kampus untuk Mahasiswa",
      "Program Beasiswa untuk Mahasiswa Berprestasi",
      "Bantuan Laptop untuk Mahasiswa Kurang Mampu",
      "Pembangunan Lab Komputer Fakultas",
      "Donasi Buku untuk Perpustakaan Desa",
      "Bantu Mahasiswa Terdampak Bencana",
      "Pelatihan Gratis untuk Mahasiswa",
    ][i % 8],
    organizer: [
  ...
  const displayedDonations = allDonations.slice(
    startIndex,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center text-primary-foreground space-y-4">
            ...
            <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto">
              Temukan program donasi yang ingin kamu dukung dan jadilah bagian dari perubahan
            </p>
          </div>
        </div>
      </section>
